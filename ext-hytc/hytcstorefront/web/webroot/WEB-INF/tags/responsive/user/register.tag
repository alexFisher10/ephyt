...
<form:form method="post" commandName="hytcRegisterForm" action="${action}">
	...
	<formElement:formPasswordBox idKey="register.checkPwd"
		...
		mandatory="true" />
	<formElement:formInputBox idKey="register.referral"
    	labelKey="register.referral" path="referralCode"
    	mandatory="false" />
