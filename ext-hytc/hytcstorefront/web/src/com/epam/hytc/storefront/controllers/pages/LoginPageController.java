...
public class LoginPageController extends DefaultAbstractLoginPageController
{
	private final static String TOKEN_PARAMETER = "returnUserToken";
	...
	public String doRegister(@RequestHeader(value = "referer", required = false) final String referer, final HytcRegisterForm form,
